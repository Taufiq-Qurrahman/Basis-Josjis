...
// =========================================================================
// 7. KELUHAN / KOMPLAIN PELANGGAN (Akses Semua Role setelah Login)
// =========================================================================
$routes->group('', ['filter' => 'role:admin,manager,owner,kasir,karyawan'], static function ($routes) {
    $routes->get('komplain', 'Komplain::index');
    $routes->post('komplain/simpan', 'Komplain::simpan');
    $routes->post('komplain/update', 'Komplain::update');
    $routes->get('komplain/hapus/(:any)', 'Komplain::hapus/$1');
});